    ...
    */
    ...
    public function actions(): array
    {
       return [
        ...
        ')
                ->class('inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-blue-700 bg-white hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500')
                ->openModal('projects-create', ['project' => 'id']),
