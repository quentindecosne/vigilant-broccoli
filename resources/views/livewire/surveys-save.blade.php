                    ...
                    <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5 pt-4">
                        <div class="mt-6 sm:mt-5 space-y-6 sm:space-y-5">
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                <label for="name" class="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">Survey
                                    Name </label>
                                <div class="mt-1 sm:mt-0 sm:col-span-2">
                                    <div class="max-w-lg flex rounded-md shadow-sm">
                                        <input wire:model="name" type="text" name="name" id="name" autocomplete="name"
                                               class="block w-full focus:ring-indigo-500 focus:border-indigo-500 min-w-0 rounded sm:text-sm border-gray-300">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                <label for="project" class="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">
                                    Project </label>
                                <div class="mt-1 sm:mt-0 sm:col-span-2">
                                    <select wire:model="project_id" id="project_id" name="project_id" autocomplete="off"
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                <label for="species_list"
                                       class="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">
                                    Species List </label>
                                <div class="mt-1 sm:mt-0 sm:col-span-2">
                                    <input type="file" id="species_list" wire:model="species_list"
                                           class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer focus:outline-none">
                                    @error('species_list') <span class="error">{{ $message }}</span> @enderror
                                </div>
                            </div>
                        </div>
                    </div>
