                    ...
                    <div class="mt-5 border-t border-gray-200">
                        <dl class="sm:divide-y sm:divide-gray-200">
                            ...
                            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4">
                                ...
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ Carbon::parse($survey->created_at)->format('d/m/Y') }}
                                    ({{ Carbon::parse($survey->created_at)->diffInDays(Carbon::now())}}
                                    days ago)
                                </dd>
                            </div>
                            @if ($survey->species_list)
                                <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 hidden">
                                    <dt class="text-sm font-medium text-gray-500">Species list</dt>
                                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                        ...
                                        <div class="w-0 flex-1 flex items-center">
                                            ...
                                            <button class="mr-1 inline-flex items-center px-2 py-0.5 rounded text-xs font-medium">
                                                <a href="{{ route('download.species_list', ['survey_id' => $survey->id]) }}"
                                                   class="text-white bg-teal-500 p-2">Download</a>
                                            </button>
                    ...
                    <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 hidden">
                        ...
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                            <ul role="list" class="border border-gray-200 rounded-md divide-y divide-gray-200">
                                ...
                                @empty
                                    <li class="pl-3 pr-4 py-3 flex items-center justify-between text-sm">
                                        <div class="w-0 flex-1 flex items-center"><span
                                                    class="ml-2 flex-1 w-0 truncate">No survey.</span></div>
                                    </li>
                                @endforelse
                            </ul>
                        </dd>
            ...
            <div class="">
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        ...
                        <p class="mt-2 text-sm text-gray-700">A list of all the plants for the survey per
                            participants.</p>
                    </div>
                </div>
